...
const CommandInput = React.forwardRef(({ className, onValueChange, isLoading: controlledLoading, ...props }, ref) => {
    ...
    return (_jsxs("div", { className: "flex items-center border-b border-gray-200 dark:border-gray-800 px-3", "cmdk-input-wrapper": "", children: [isLoading ? (_jsx(Loader2, { className: "mr-2 h-4 w-4 animate-spin opacity-70" })) : (_jsx(Search, { className: "mr-2 h-4 w-4 shrink-0 opacity-50" })), _jsx("input", { ref: ref, value: props.value !== undefined ? props.value : value, onChange: handleChange, onKeyDown: handleKeyDown, className: cn(`flex h-11 w-full rounded-md bg-transparent py-3 text-sm border-none focus:border-none focus:ring-0 focus:outline-none 

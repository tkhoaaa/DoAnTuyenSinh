...
const SheetContent = React.forwardRef(({ side = "right", className, children, ...props }, ref) => {
    ...
    return createPortal(_jsx(AnimatePresence, { children: open && (_jsxs(SheetPortal, { children: [_jsx(SheetOverlay, {}), _jsxs(motion.div, { ref: combinedRef, initial: sideVariants[side].initial, animate: sideVariants[side].animate, exit: sideVariants[side].exit, transition: { duration: 0.3, ease: "easeInOut" }, className: cn("fixed z-50 gap-4 bg-background p-6 shadow-lg", side === "top" && "inset-x-0 top-0 border-b border-gray-200 dark:border-gray-800", side === "bottom" && "inset-x-0 bottom-0 border-t border-gray-200 dark:border-gray-800", side === "left" && "inset-y-0 left-0 h-full w-3/4 border-r border-gray-200 dark:border-gray-800 sm:max-w-sm", side === "right" && "inset-y-0 right-0 h-full w-3/4 border-l border-gray-200 dark:border-gray-800 sm:max-w-sm", className), ...restProps, children: [children, _jsxs(SheetClose, { className: "absolute right-4 top-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none", children: [_jsx(X, { className: "h-4 w-4" }), _jsx("span", { className: "sr-only", children: "Close" })] })] }, "sheet-content")] })) }), document.body);
});

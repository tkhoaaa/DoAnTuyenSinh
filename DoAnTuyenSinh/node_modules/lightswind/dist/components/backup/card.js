...
const Card = React.forwardRef(({ className, hoverable = false, bordered = false, compact = false, ...props }, ref) => (_jsx("div", { ref: ref, className: cn("rounded-lg bg-card text-card-foreground shadow-sm", bordered ? "border" : "border border-gray-200 dark:border-gray-800", hoverable ? "transition-shadow duration-200 hover:shadow-md" : "", compact ? "p-3" : "p-0", className), ...props })));

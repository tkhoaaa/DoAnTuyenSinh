...
function Menubar({ className, children, ...props }) {
    ...
    return (_jsx(MenubarContext.Provider, { value: { openMenu, setOpenMenu }, children: _jsx("div", { className: cn("flex h-10 items-center space-x-1 rounded-md border border-gray-200 dark:border-gray-800 bg-background p-1", className), role: "menubar", ...props, children: children }) }));
}

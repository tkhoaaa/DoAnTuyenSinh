...
const TabsList = React.forwardRef(({ className, ...props }, ref) => {
    ...
    return (_jsxs("div", { ref: (el) => {
            if (typeof ref === "function")
                ...
                ref.current = el;
            registerTabsList(el);
        }, className: cn(`relative inline-flex h-10 items-center justify-center rounded-full
           bg-muted  text-primary`, className), ...props, children: [_jsx(motion.div, { layout: true, className: "tabs-bg-indicator  absolute top-0 left-0 h-full rounded-sm\r\n   bg-gradient-tabs", style: {
                    ...indicatorStyle,
                    position: "absolute",
                    top: 0,
                    borderRadius: '50px',
...
const TabsTrigger = React.forwardRef(({ className, value, ...props }, ref) => {
    ...
    return (_jsx("button", { ref: (el) => {
         ...
         focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50`, isActive && "text-white dark:text-black", className), onClick: () => onValueChange(value), ...props }));
});
TabsTrigger.displayName = "TabsTrigger";
const TabsContent = React.forwardRef(({ className, value, ...props }, ref) => {
    const { value: selectedValue } = React.useContext(TabsContext);
    const isActive = selectedValue === value;
    return (_jsx(AnimatePresence, { mode: "wait", children: isActive && (_jsx("div", { ref: ref, role: "tabpanel", "data-state": "active", "data-value": value, className: cn(`mt-2 ring-offset-background focus-visible:outline-none 
            overflow-scroll focus-visible:ring-2 focus-visible:ring-ring 
            focus-visible:ring-offset-2`, className), style: {
                scrollbarWidth: "none",

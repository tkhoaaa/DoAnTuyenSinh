...
const HoverCardContent = React.forwardRef(({ className, align = "center", sideOffset = 4, ...props }, ref) => {
    ...
    return (_jsx(AnimatePresence, { children: open && ( // Conditionally render the motion.div based on `open` state
        _jsx(motion.div, { ref: ref, initial: { opacity: 0, scale: 0.95, y: -5 }, animate: { opacity: 1, scale: 1, y: 0 }, exit: { opacity: 0, scale: 0.95, y: -5 }, transition: { duration: 0.2, ease: "easeOut" }, className: cn(`absolute z-50 w-64 rounded-md border border-gray-200 dark:border-gray-800 bg-white

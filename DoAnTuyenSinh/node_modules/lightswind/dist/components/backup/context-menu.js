...
const ContextMenuSubContent = React.forwardRef(({ className, ...props }, ref) => (_jsx("div", { ref: ref, className: cn("z-50 min-w-[8rem] overflow-hidden rounded-md border border-gray-200 dark:border-gray-800 bg-popover p-1 text-popover-foreground shadow-md", className), ...props })));

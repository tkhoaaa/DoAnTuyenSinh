...
export const GlowingCard = ({ children, className, glowColor = "#3b82f6", hoverEffect = true, ...props }) => {
    return (_jsx("div", { className: cn("relative flex-1 min-w-[14rem] p-6 rounded-2xl text-black dark:text-white", "bg-white dark:bg-black border border-gray-200 dark:border-gray-700", "transition-all duration-400 ease-out", 

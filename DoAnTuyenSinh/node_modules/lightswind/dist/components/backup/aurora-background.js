...
export const AuroraBackground = ({ className, children, showRadialGradient = true, ...props }) => {
    return (_jsx("main", { children: _jsxs("div", { className: cn(`transition-bg relative flex mx-auto h-[100vh] flex-col 
          items-center justify-center bg-zinc-50 
          text-slate-950 dark:bg-zinc-900`, className), ...props, children: [_jsx("div", { className: "absolute inset-0 overflow-hidden", style: {

...
const AccordionItem = React.forwardRef(({ className, value, disabled = false, children, ...props }, ref) => {
    return (_jsx(AccordionItemContext.Provider, { value: { value }, children: _jsx("div", { ref: ref, className: cn("border-b border-gray-200 dark:border-gray-800 text-black dark:text-white", className), "data-state": disabled ? "disabled" : undefined, "data-value": value, ...props, children: children }) }));
});
